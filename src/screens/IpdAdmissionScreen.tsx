...
type ScreenRouteProp = RouteProp<RootStackParamList, 'IpdAdmission'>;
...
export const IpdAdmissionScreen: React.FC = () => {
  ...
  const handleAdmit = () => {
    ...
    Alert.alert(
      ...
      [
        ...
        {
          text: 'Go to Patients',
          onPress: () => navigation.navigate('Main', { screen: 'Patients' }),
        },
      ]
    );
  };
