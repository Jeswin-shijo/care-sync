...
type ScreenRouteProp = RouteProp<RootStackParamList, 'PatientDetails'>;
      ...
      >
            ...
            <View style={styles.profileDetails}>
              <View style={styles.nameBadgeRow}>
                ...
                <Badge
                  ...
                  variant={patient.status === 'Active' ? 'active' : patient.status === 'Admitted' ? 'admitted' : 'discharged'}
                  size="sm"
                />
              </View>
        ...
        <View style={styles.actionButtonsRow}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OpdConsultation', { patientId: patient.id })}
          >
          ...
          <TouchableOpacity
            style={styles.actionBtn}
            onPress={() => navigation.navigate('IpdAdmission', { patientId: patient.id })}
          >
          ...
          <TouchableOpacity
            style={styles.actionBtn}
            onPress={() => navigation.navigate('DischargeSummary', { patientId: patient.id })}
          >
            ...
            <View style={styles.infoSectionCard}>
              ...
              {patientInvoices.map((inv) => (
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate('ReceiptDetail', { invoiceId: inv.id })}
                >
