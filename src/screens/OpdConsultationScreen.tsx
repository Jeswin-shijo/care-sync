...
type ScreenRouteProp = RouteProp<RootStackParamList, 'OpdConsultation'>;
...
export const OpdConsultationScreen: React.FC = () => {
  ...
  const [symptoms, setSymptoms] = useState('Patient presents with moderate fever (101°F) for 3 days, accompanied by generalized body ache, fatigue, and mild dry cough.');
